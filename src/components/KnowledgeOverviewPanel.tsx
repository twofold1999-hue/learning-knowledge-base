...
function symmetric(relation: KnowledgeRelation): boolean { return relation.relationType === 'related_to' || relation.relationType === 'contrasts_with' }
